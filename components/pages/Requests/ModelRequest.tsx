      ...
      <View style={styles.tableContainer}>
        ...
        >
          <View style={styles.containerInputs}>
            <Text style={[styles.mainText,{color:"black"}]}>Поиск информации о конкретной модели</Text>
            <TextInput
            placeholder="Введите название модели с большой буквы"
            value={searchName}
            ...
            onPress={async()=>{
              await dataBase.searchModel(searchName,setModels).catch(error => Errors.showError(error))
